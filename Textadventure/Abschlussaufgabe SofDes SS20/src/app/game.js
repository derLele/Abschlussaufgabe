...
class TSCGame {
    constructor(app) {
        ...
        this.allRooms = [new TSCRoomMain, new TSCRoomNorth, new TSCRoomSouth, new TSCRoomEast, new TSCRoomWest];
        this.startMessageText = "Abschlussaufgabe SofDes SS20 \n";
        this.storyText = "";
        this.mainApp = app;
    ...
    executeGameCommand(strCommand, itemOrCharacter) {
        let commands = this.gameCommands;
        let longCommand = strCommand;
        //  game was quit
        if (!this.gameRunning)
            return;
